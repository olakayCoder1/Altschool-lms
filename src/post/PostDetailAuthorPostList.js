        ...
        <div className=' w-full border  p-4'>
            <div className=' w-full h-fit border-gray-200 py-4'>
              ...
              <div className=' flex flex-col gap-2'>
                ...
                <p className='font-normal text-sm p-1 max-w-[100px] px-3 rounded-md bg-blue-700 text-gray-100 hover:bg-blue-800 cursor-pointer flex items-center place-content-center'><span>Follow</span></p>
              </div>
            </div>
